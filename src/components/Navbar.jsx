...
const Navbar = () => {
  return (
   <nav className='flex justify-around text-white my-4 items-center'>
     
    <div className='logo text-xl font-semibold cursor-pointer flex items-center justify-center'>
    <RiLockStarLine />
        <span>Pass</span>
        <span className='text-gray-400'>HOLD</span> </div>
